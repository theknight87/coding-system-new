...
// adminOnly flags control sidebar visibility per role
const NAV = [
...
  // Initialise all data — useDb fetches from Supabase when env vars are set,
  // otherwise falls back to INIT_* constants so the app works offline/local.
  const initData = {
...
  // Convenience setters that mirror the old pattern, wiring through setState
  const mk = (key) => (valOrFn) => setState(prev => ({
    ...prev,
...
    ...state,
    dbReady,
    setCategories:    mk('categories'),
    setManufacturers: mk('manufacturers'),
    setModels:        mk('models'),
    setDisciplines:   mk('disciplines'),
    setEngineSystems: mk('engineSystems'),
    setFuncGroups:    mk('funcGroups'),
    setParts:         mk('parts'),
  };
...
        {/* Loading overlay */}
        {loading && (
          <div style={{ position:"absolute",top:0,left:0,right:0,height:3,background:`linear-gradient(90deg,${T.accent},#38bdf8)`,zIndex:9999,animation:"none" }}/>
        )}
