# Graph Report - coding-system-new  (2026-08-29)

## Corpus Check
- 150 files · ~167,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2410 nodes · 2873 edges · 168 communities (135 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cd838e8`
...
### Community 4 - "Tailwind CSS Utility Reference"
Cohesion: 0.05
Nodes (43): Arbitrary Values, Aspect Ratio, Background Colors, Border Color, Border Radius, Border Style, Border Width, Borders (+35 more)

### Community 5 - "App.jsx"
Cohesion: 0.05
Nodes (23): App(), AppShell(), AuditLogPage(), AuthContext, AuthGate(), AuthProvider(), COLOR_PRESETS, ENGINE_SYSTEMS (+15 more)
...
### Community 7 - "db.js"
Cohesion: 0.14
Nodes (38): mapCat(), mapDisc(), mapEng(), mapFg(), mapMfr(), mapModel(), useDb(), audit() (+30 more)

### Community 8 - "Brand Guidelines v1.0"
Cohesion: 0.05
...
### Community 10 - "Canvas Design System"
Cohesion: 0.06
...
### Community 14 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 15 - "Typography Specifications"
Cohesion: 0.06
...
### Community 19 - "shadcn/ui Accessibility Patterns"
Cohesion: 0.07
...
### Community 21 - "html-token-validator.py"
Cohesion: 0.13
Nodes (24): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+16 more)

### Community 22 - "Tasks: [FEATURE NAME]"
Cohesion: 0.07
...
### Community 25 - "speckit-analyze/SKILL.md"
Cohesion: 0.08
Nodes (25): 1. Initialize Analysis Context, 2. Load Artifacts (Progressive Disclosure), 3. Build Semantic Models, 4. Detection Passes (Token-Efficient Analysis), 5. Severity Assignment, 6. Produce Compact Analysis Report, 7. Provide Next Actions, 8. Offer Remediation (+17 more)

### Community 26 - "Color Palette Management"
Cohesion: 0.08
...
### Community 27 - "CIP Deliverable Guide"
Cohesion: 0.08
...
### Community 29 - "States and Variants"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (24): dependencies, react, react-dom, @supabase/supabase-js, devDependencies, @types/react, @types/react-dom, vite (+16 more)
...
### Community 36 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 37 - "TailwindConfigGenerator"
Cohesion: 0.10
...
### Community 40 - "generate-slide.py"
Cohesion: 0.15
Nodes (19): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+11 more)

### Community 41 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (18): Architecture Rules, Audit Log, Authentication, Authorization, Cloudflare, Coding Rules, Database Rules, Engineering Spare Parts Master Coding System (+10 more)

### Community 43 - "Asset Organization Guide"
Cohesion: 0.11
...
### Community 46 - "test_design_system_mode.py"
Cohesion: 0.16
...
### Community 51 - "Supabase Setup Guide"
Cohesion: 0.11
Nodes (17): 001 — Initial Schema, 002 — Seed Data, 003 — RLS Policies, 004 — Audit Triggers, Engineering Spare Parts Master Coding System v3.0, Files Changed in v3.0, Local Development, Role Permissions Summary (+9 more)
...
### Community 53 - "UI/UX Pro Max - Design Intelligence"
Cohesion: 0.12
...
### Community 65 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
...
### Community 66 - "Messaging Framework"
Cohesion: 0.14
...
### Community 67 - "Brand Voice Framework"
Cohesion: 0.14
...
### Community 68 - "extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 69 - "validate-asset.cjs"
Cohesion: 0.25
...
### Community 71 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 74 - "fetchPartsCount"
Cohesion: 0.18
Nodes (14): CategoriesPage(), CodeGeneratorPage(), Dashboard(), DisciplinesPage(), FunctionalGroupsPage(), HierarchyTreePage(), ManufacturersPage(), mapPart() (+6 more)

### Community 75 - "brand/references/update.md"
Cohesion: 0.15
...
### Community 78 - "Pre-Delivery Checklist (canonical — the only one)"
Cohesion: 0.15
...
### Community 86 - "Core Visual Elements"
Cohesion: 0.18
Nodes (10): Color Palette, Colors, Core Visual Elements, Logo, Logo, Quick Checks, Typography, Typography (+2 more)

### Community 87 - "inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 88 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 89 - "embed-tokens.cjs"
Cohesion: 0.18
Nodes (8): args, fs, minimal, MINIMAL_TOKENS, path, projectRoot, tokensPath, wrapStyle

### Community 90 - "speckit-plan/SKILL.md"
Cohesion: 0.18
Nodes (10): Completion Report, Done When, Key rules, Mandatory Post-Execution Hooks, Outline, Phase 0: Outline & Research, Phase 1: Design & Contracts, Phases (+2 more)

### Community 91 - "speckit-specify/SKILL.md"
Cohesion: 0.18
Nodes (10): Completion Report, Done When, For AI Generation, Mandatory Post-Execution Hooks, Outline, Pre-Execution Checks, Quick Guidelines, Section Requirements (+2 more)

### Community 92 - "speckit-tasks/SKILL.md"
Cohesion: 0.18
...
### Community 94 - "test_tailwind_config_gen.py"
Cohesion: 0.22
Nodes (8): Tests for tailwind_config_gen.py, Reduce a generated TS/JS config to a bare assignable object so it can be handed…, Regression guard for the missing-comma bug between the ``theme`` block and…, The property preceding ``plugins`` must end with a comma (pure-Python check, so…, The emitted config parses as valid JS via ``node --check``., _strip_to_object(), TestGeneratedConfigIsValidJs, parametrize

### Community 95 - "Core Principles"
Cohesion: 0.18
Nodes (10): Core Principles, Development Workflow & Quality Gates, Engineering Spare Parts Master Coding System Constitution, Governance, I. Preserve the Existing Architecture (NON-NEGOTIABLE), II. Fixed Technology Stack & Cloudflare Compatibility, III. Role-Based Authorization Is Enforced Everywhere, IV. Data Integrity, Soft Delete, and No Duplicate Codes (+2 more)
...
### Community 100 - "logo/generate.py"
Cohesion: 0.29
...
### Community 103 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 104 - "sync-brand-to-tokens.cjs"
Cohesion: 0.33
...
### Community 107 - "Implementation Plan: [FEATURE]"
Cohesion: 0.22
...
### Community 113 - "speckit-clarify/SKILL.md"
Cohesion: 0.29
Nodes (6): Completion Report, Done When, Mandatory Post-Execution Hooks, Outline, Pre-Execution Checks, User Input

### Community 114 - "speckit-implement/SKILL.md"
Cohesion: 0.29
Nodes (6): Completion Report, Done When, Mandatory Post-Execution Hooks, Outline, Pre-Execution Checks, User Input
...
### Community 116 - "_select_palette_for_mode"
Cohesion: 0.43
...
### Community 121 - "TrashPage"
Cohesion: 0.33
Nodes (6): TrashPage(), emptyTrash(), fetchAllTrash(), fetchTrash(), hardDeleteRecord(), restoreRecord()

### Community 122 - "Brand Guidelines Template"
Cohesion: 0.40
...
### Community 124 - "speckit-taskstoissues/SKILL.md"
Cohesion: 0.40
Nodes (4): Outline, Post-Execution Checks, Pre-Execution Checks, User Input

### Community 125 - "[CHECKLIST TYPE] Checklist: [FEATURE NAME]"
Cohesion: 0.40
Nodes (4): [Category 1], [Category 2], [CHECKLIST TYPE] Checklist: [FEATURE NAME], Notes

### Community 126 - "UsersPage"
Cohesion: 0.30
Nodes (5): FileUpload(), UsersPage(), fetchAllUsers(), uploadFile(), upsertUserProfile()

### Community 127 - "default"
Cohesion: 0.67
...
### Community 130 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 131 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
...
### Community 133 - "validate_data.py"
Cohesion: 0.83
Nodes (3): _check_file(), main(), _read_rows()

## Knowledge Gaps
- **1162 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1157 more)
...
- **Are the 6 inferred relationships involving `useDb()` (e.g. with `mapCat()` and `mapDisc()`) actually correct?**
  _`useDb()` has 6 INFERRED edges - model-reasoned connections that need verification._
